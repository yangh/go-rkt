...
│   ├── board.rkt         # Board data structures and operations
│   ├── stone.rkt         # Stone type definitions
│   ├── rules.rkt         # Go rules engine (core algorithms)
│   ├── game-engine.rkt   # Main game engine
│   ├── game-state.rkt    # Game state management
│   ├── custom-format.rkt # Custom game record format handling
│   ├── sgf-format.rkt    # SGF standard format handling
│   ├── ko-rule.rkt       # Ko rule implementation
│   ├── scoring.rkt       # Scoring system
│   ├── gui-main.rkt      # Graphical user interface
│   └── main.rkt          # Program entry point
├── tests/            # Test files
│   └── *test*.rkt        # Various feature tests
├── analysis/         # Analysis and debugging tools
│   └── *analysis*.rkt    # Problem analysis and algorithm debugging
├── data/             # Game data files
│   └── game-01.txt       # Sample game record
├── docs/             # Documentation
...
### 🎯 Core Game Features
- ✅ **Complete Go Rules**: Supports Chinese rules (area scoring)
- ✅ **Move Validation**: Automatically detects illegal moves (suicide, ko, etc.)
- ✅ **Real-time Scoring**: Dynamically displays captured stones for both players
- ✅ **Position Analysis**: One-click popup showing current territory and lead
- ✅ **Game End Detection**: Automatically detects double-pass and calculates winner

### 📝 Game Record Features
- ✅ **SGF Format Support**: Save and load standard SGF game records
- ✅ **Custom Format**: Human-readable text format for saving games
- ✅ **Move History**: Complete record of the game

### 🔁 Replay Features
- ✅ **Undo**: Support for undoing moves
- ✅ **Replay Mode**: Switch between game mode and replay mode
- ✅ **Player-style Controls**: Jump to first/last move, forward/back 1 or 5 moves
- ✅ **Read-only Review**: Placing stones, passing, resigning, and undoing are disabled in replay mode

### 🖥️ Graphical Interface
- ✅ **Intuitive Board**: 19×19 standard board display
- ✅ **Mouse Control**: Click to place stones
