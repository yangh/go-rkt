...
(define translations
  (hash
   ...
   (hash
    ...
    'menu-recent-files "最近文件"
    'menu-recent-files-empty "无最近文件"
    'menu-clear-recent "清除最近文件列表"
    'msg-file-not-found "文件不存在，已从列表中移除: ~a"
    'menu-exit "退出"
    'menu-about "关于"
    'msg-unsupported-file "不支持的文件格式"
    'menu-lang-zh "中文"
    'menu-lang-en "英文"
   ...
   (hash
    ...
    'menu-recent-files "Recent Files"
    'menu-recent-files-empty "No Recent Files"
    'menu-clear-recent "Clear Recent Files"
    'msg-file-not-found "File not found, removed from list: ~a"
    'menu-exit "Exit"
    'menu-about "About"
    'msg-unsupported-file "Unsupported file format"
