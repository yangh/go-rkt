...
### 设置界面语言
```bash
racket src/main.rkt --lang en   # 英文（默认）
racket src/main.rkt --lang zh   # 中文
```
...
3. **认输**：点击控制面板的"认输"按钮
4. **悔棋**：点击控制面板的"悔棋"按钮
5. **局势**：点击"局势"按钮，弹窗显示当前黑白总目和领先差距
6. **复盘模式**：点击"复盘"进入复盘模式，按钮文案会变为"结束"，再次点击可退出复盘模式
7. **语言切换**：菜单栏“语言”中选择“中文”或“英文”
...
- **最近文件**：文件菜单 → 最近文件（显示最近打开的10个文件，点击快速打开）
